...
class __TwigTemplate_4b7367cf70fc0643c749fa82eee85f85d6204e90b9fe8676da36e326d7020765 extends Twig_Template
{
 ...
 <fieldset>
    <div class=\"form-group\">
      ...
      <div class=\"controls col-md-8 radios\" id=\"default-avatar\" >
        ";
        // line 13
        echo $this->env->getExtension('Topxia\WebBundle\Twig\Extension\HtmlExtension')->radios("avatar", array(1 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("自定义默认头像"), 0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("系统默认头像")), (($this->getAttribute((isset($context["defaultSetting"]) ? $context["defaultSetting"] : null), "defaultAvatar", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["defaultSetting"]) ? $context["defaultSetting"] : null), "defaultAvatar", array()), 0)) : (0)));
        echo "
        <p>";
        // line 14
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("网校内未上传头像的用户，都会显示该默认头像。推荐尺寸（270*270）"), "html", null, true);
        echo "</p>    
        ";
        // line 15
