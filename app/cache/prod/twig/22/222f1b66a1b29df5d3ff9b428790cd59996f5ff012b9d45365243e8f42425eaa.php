...
class __TwigTemplate_86ef5e1d1d9930bdad3276c91c24ab404e5d1ddcdddca8f26c0abf75cd9e25ba extends Twig_Template
{
    ...
    public function block_main($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_invite");
...
\t\t\t\t<th width=\"10%\">";
        // line 15
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("邀请人数"), "html", null, true);
        echo "</th>
\t\t\t\t<th width=\"15%\">";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("付费用户数"), "html", null, true);
        echo "</th>
\t\t\t\t<th width=\"20%\">";
        // line 17
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("订单消费总额"), "html", null, true);
        echo "</th>
\t\t\t\t<th width=\"15%\">";
        // line 18
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("订单虚拟币总额"), "html", null, true);
        echo "</th>
\t\t\t\t<th width=\"15%\">";
        // line 19
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("订单现金总额"), "html", null, true);
        echo "</th>
\t\t\t\t<th width=\"10%\">";
        // line 20
...
\t\t\t\t\t<td><a href=\"#modal\" data-toggle=\"modal\" class=\"btn btn-default\" data-url=\"";
                // line 33
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_invite_detail", array("inviteUserId" => $this->getAttribute($context["inviteInformation"], "id", array()), "payingUserCount" => $this->getAttribute($context["inviteInformation"], "payingUserCount", array()))), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("详细"), "html", null, true);
                echo "</a>
\t\t\t\t\t</td>
\t\t\t\t\t</tr>
\t\t\t\t";
