...
class __TwigTemplate_4747ff606f51bd688d58c0262cda539ddc5e7a834ff819ed4c8d7262ddd9d056 extends Twig_Template
{
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        if ((($this->getAttribute((isset($context["navigation"]) ? $context["navigation"] : null), "id", array()) == 0) && ($this->getAttribute((isset($context["navigation"]) ? $context["navigation"] : null), "type", array()) == "top"))) {
            // line 6
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("新增顶部导航"), "html", null, true);
            echo "
";
...
(isset($context["navigation"]) ? $context["navigation"] : null), "id", array()) > 0) && ($this->getAttribute((isset($context["navigation"]) ? $context["navigation"] : null), "type", array()) == "top"))) {
            // line 8
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("编辑顶部导航"), "html", null, true);
            echo "
";
...
(isset($context["navigation"]) ? $context["navigation"] : null), "id", array()) == 0) && ($this->getAttribute((isset($context["navigation"]) ? $context["navigation"] : null), "type", array()) == "foot"))) {
            // line 10
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("新增底部导航"), "html", null, true);
            echo "
";
        } elseif ((($this->getAttribute(        // line 11
(isset($context["navigation"]) ? $context["navigation"] : null), "id", array()) > 0) && ($this->getAttribute((isset($context["navigation"]) ? $context["navigation"] : null), "type", array()) == "foot"))) {
            // line 12
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("编辑底部导航"), "html", null, true);
            echo "
";
...
(isset($context["navigation"]) ? $context["navigation"] : null), "id", array()) == 0) && ($this->getAttribute((isset($context["navigation"]) ? $context["navigation"] : null), "type", array()) == "friendlyLink"))) {
            // line 14
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("新增友情链接"), "html", null, true);
            echo "
";
        } elseif ((($this->getAttribute(        // line 15
(isset($context["navigation"]) ? $context["navigation"] : null), "id", array()) > 0) && ($this->getAttribute((isset($context["navigation"]) ? $context["navigation"] : null), "type", array()) == "friendlyLink"))) {
            // line 16
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("编辑友情链接"), "html", null, true);
            echo "
";
        }
        // line 18
...
";
  ...
  ";
    ...
    <div class=\"col-md-3 control-label\"><label>";
            // line 33
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("上级导航"), "html", null, true);
            echo "</label></div>
    <div class=\"col-md-8 controls\"> 
      ...
      <div class=\"help-block\">";
            // line 36
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("请注意：增加子导航后，对应的上级导航链接将不起作用。"), "html", null, true);
            echo "</div>
    </div>
  </div>
  ";
...
";
    ...
    {
        return array (  270 => 104,  265 => 103,  262 => 102,  256 => 98,  252 => 96,  248 => 94,  246 => 93,  238 => 88,  234 => 87,  227 => 83,  221 => 82,  216 => 80,  210 => 79,  202 => 74,  192 => 67,  186 => 66,  181 => 64,  175 => 63,  168 => 59,  162 => 56,  146 => 51,  142 => 50,  134 => 45,  129 => 43,  124 => 40,  117 => 36,  113 => 35,  108 => 33,  105 => 32,  103 => 31,  99 => 29,  93 => 27,  87 => 25,  85 => 24,  81 => 22,  78 => 21,  73 => 18,  68 => 16,  66 => 15,  62 => 14,  60 => 13,  56 => 12,  54 => 11,  50 => 10,  48 => 9,  44 => 8,  42 => 7,  38 => 6,  36 => 5,  33 => 4,  29 => 1,  27 => 2,  11 => 1,);
    }
