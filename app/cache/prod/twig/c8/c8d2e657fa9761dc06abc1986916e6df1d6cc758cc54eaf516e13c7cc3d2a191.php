...
class __TwigTemplate_b56086fd1cd0914842d8d705a03d1e427e17b395c7abbb09cd73b3f3aac30dfd extends Twig_Template
{
    ...
    <div class=\"form-group\">
      ...
      <div class=\"col-md-6\">
        ...
        ";
            ...
            ";
                    // line 45
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("当前域名 %currentHost% 与授权域名不符，将会影响%EduSoho%系统功能的使用；请使用授权域名访问此系统。", array("%currentHost%" => (isset($context["currentHost"]) ? $context["currentHost"] : null), "%EduSoho%" => $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->removeCopyright("EduSoho"))), "html", null, true);
                    echo "
          </div>
        ";
                }
