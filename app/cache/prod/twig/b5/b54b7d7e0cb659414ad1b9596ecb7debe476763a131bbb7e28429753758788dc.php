...
class __TwigTemplate_fff65b121b767441a579187c63e3890928d1d7115afaa8394ac35b4454d42a2e extends Twig_Template
{
  ...
  ";
        ...
        if ($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "debug", array())) {
            ...
            echo "\" target=\"_blank\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("查看JSON配置"), "html", null, true);
            echo "</a>
  ";
        }
        // line 36
        echo "  ";
        if ((((($this->getAttribute((isset($context["block"]) ? $context["block"] : null), "code", array()) != "jianmo:home_top_banner") && ($this->getAttribute((isset($context["block"]) ? $context["block"] : null), "code", array()) != "live_top_banner")) && ($this->getAttribute((isset($context["block"]) ? $context["block"] : null), "code", array()) != "open_course_top_banner")) && ($this->getAttribute((isset($context["block"]) ? $context["block"] : null), "code", array()) != "cloud_search_banner"))) {
            // line 37
