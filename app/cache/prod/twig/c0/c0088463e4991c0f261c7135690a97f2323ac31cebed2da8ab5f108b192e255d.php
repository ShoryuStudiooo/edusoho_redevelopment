...
class __TwigTemplate_f6f4c78046da6532b66b91aeeac43db93b3ea0c755797da3aa5fb1a25dad9497 extends Twig_Template
{
  ...
  <fieldset>
    <div class=\"form-group\">
      ...
      <div class=\"controls col-md-8 radios\" id=\"defaultCoursePicture\">
        ";
        // line 15
        echo $this->env->getExtension('Topxia\WebBundle\Twig\Extension\HtmlExtension')->radios("coursePicture", array(1 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("自定义默认课程图片"), 0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("系统默认课程图片")), (($this->getAttribute((isset($context["defaultSetting"]) ? $context["defaultSetting"] : null), "defaultCoursePicture", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["defaultSetting"]) ? $context["defaultSetting"] : null), "defaultCoursePicture", array()), 0)) : (0)));
        echo "
        <p>";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("支持jpg、gif、png格式的图片，建议尺寸：480*270px."), "html", null, true);
        echo "</p>
        ";
        // line 17
