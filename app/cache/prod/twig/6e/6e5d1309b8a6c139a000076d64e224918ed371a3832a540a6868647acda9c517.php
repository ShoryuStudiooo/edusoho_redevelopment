...
class __TwigTemplate_b902e84dfd2f212891f66955a2ad0823bf19b5ce7653e17e4d093f26d801fb79 extends Twig_Template
{
    ...
    public function block_title($context, array $blocks = array())
    {
        if ($this->getAttribute((isset($context["category"]) ? $context["category"] : null), "id", array())) {
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("编辑栏目"), "html", null, true);
        } else {
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("添加栏目"), "html", null, true);
        }
    }
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["category"]) ? $context["category"] : null), "id", array())) {
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_article_category_edit", array("id" => $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "id", array()))), "html", null, true);
        } else {
            echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_article_category_create");
        }
        echo "\" method=\"post\">
...
\t\t\t<label class=\"col-md-2 control-label\" for=\"category-code-field\">";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("栏目编码"), "html", null, true);
        echo "</label>
\t\t\t<div class=\"col-md-8 controls\">
\t\t\t\t<input class=\"form-control\" id=\"category-code-field\" type=\"text\" name=\"code\" value=\"";
        ...
        echo "\" data-url=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_article_category_checkcode", array("exclude" => $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "code", array()))), "html", null, true);
        echo "\" tabindex=\"2\">
\t\t\t\t<div class=\"help-block\">";
        // line 19
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("生成列表、资讯时使用，例如news、bbs等"), "html", null, true);
        echo "</div>
\t\t\t</div>
\t\t</div>
...
\t\t\t<label class=\"col-md-2 control-label\" for=\"category-parentId-field\">";
        // line 24
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("父栏目"), "html", null, true);
        echo "</label>
\t\t\t<div class=\"col-md-8 controls\">
\t\t\t\t<select class=\"form-control category-select\" id=\"category-parentId-field\" type=\"text\" name=\"parentId\" tabindex=\"2\" data-url=\"";
        // line 26
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_article_category_checkparentid", array("currentId" => $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "id", array()))), "html", null, true);
        echo "\">
\t\t\t\t\t<option value=\"0\">--";
        // line 27
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("选择栏目"), "html", null, true);
        echo "--</option>
\t\t\t\t\t";
        // line 28
...
\t\t\t<label class=\"col-md-2 control-label\" for=\"category-publishArticle-field\">";
        // line 36
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("允许发布资讯"), "html", null, true);
        echo "</label>
...
\t\t\t<label class=\"col-md-2 control-label\" for=\"category-seoTitle-field\">";
        // line 47
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("SEO标题"), "html", null, true);
        echo "</label>
\t\t\t<div class=\"col-md-8 controls\">
...
\t\t\t<label class=\"col-md-2 control-label\" for=\"category-seoKeyword-field\">";
        // line 55
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("SEO关键字"), "html", null, true);
        echo "</label>
\t\t\t<div class=\"col-md-8 controls\">
...
\t\t\t<label class=\"col-md-2 control-label\" for=\"category-seoDesc-field\">";
        // line 63
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("SEO描述"), "html", null, true);
        echo "</label>
\t\t\t<div class=\"col-md-8 controls\">
...
\t\t\t<label class=\"col-md-2 control-label\" for=\"category-published-field\">";
        // line 71
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("启用"), "html", null, true);
        echo "</label>
...
\t\t\t\t<div class=\"help-block\">";
        // line 75
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("建议等栏目内容整理编辑完毕后再启用"), "html", null, true);
        echo "</div>
\t\t\t</div>
\t\t</div>
...
";
    ...
    public function block_footer($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["category"]) ? $context["category"] : null), "id", array())) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_article_category_delete", array("id" => $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "id", array()))), "html", null, true);
